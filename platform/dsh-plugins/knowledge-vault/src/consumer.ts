 ...
 *
 * 注意：本文件是 @lumo/knowledge-vault 的自包含副本（来源：
 * platform/dsh-plugins/knowledge/src/consumer.ts，权威定义）。打包成桌面包时
 * 没有 @lumo/knowledge 与 platform/shared 可解析，类型改走 ./seam-contracts.ts，
 * 修改权威版请同步本文件（含 rerank.ts / seam-contracts.ts / seam-errors.ts）。
 */
